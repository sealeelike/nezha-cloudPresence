...
const serviceFormSchema = z.object({
    ...
    cron_rule: asOptionalField(z.string()),
                        ...
                        <Form {...form}>
                            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-2 my-2">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input
                                                    placeholder="HTTP (https://t.tt)｜Ping (t.tt)｜TCP (t.tt:80)｜Traceroute (8.8.8.8)"
                                                    {...field}
                                                />
                                            </FormControl>
                                            <FormMessage />
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormLabel>{t("CronRule")}</FormLabel>
                                            <FormControl>
                                                <Input placeholder="0 0 3 * * *" {...field} />
                                            </FormControl>
                                            <FormMessage />
                                        </FormItem>
                                    )}
